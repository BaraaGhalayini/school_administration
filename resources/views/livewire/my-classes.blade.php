<button class="btn btn-success btn-sm btn-lg pull-right" wire:click="showformadd" type="button">ddddd</button><br><br>
    ...
    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
        ...
        @foreach ($my_parents as $my_parent)
            <tr>
                ...
                <td>
                    <button wire:click="edit({{ $i }})" title="{{ trans('Grades_trans.Edit') }}"
                    ...
                    <button type="button" class="btn btn-danger btn-sm" wire:click="delete({{ $i }})" title="{{ trans('Grades_trans.Delete') }}"><i class="fa fa-trash"></i></button>
                </td>
            </tr>
        @endforeach
    </table>
